...
const navigation = [
  ...
  {
    name: "Games Ratings",
    href: "http://localhost:3000/games-rating",
    current: false,
  },
  {
    name: "Games Popularity",
    href: "http://localhost:3000/games-popularity",
    current: false,
  },
  {
    name: "Mutual Friends",
    href: "http://localhost:3000/mutual-friends",
    current: false,
  },
  {
    name: "Developer Page",
    href: "http://localhost:3000/developer-page",
    current: false,
  },
];
